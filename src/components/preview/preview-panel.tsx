...
export function PreviewPanel() {
  ...
  const renderContent = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center text-center">
        <div className="h-16 w-16 rounded-full bg-[#1a1a24] flex items-center justify-center mb-4">
  ...
  return (
    <div className="flex h-full flex-col bg-[#0c0c10]">
      <div className="flex h-10 items-center justify-between border-b border-[#1a1a24] px-3">
        ...
        <div className="flex items-center gap-1">
          <button 
            ...
            disabled={!previewUrl}
            className="rounded p-1.5 text-zinc-500 transition-colors hover:bg-[#1a1a24] hover:text-zinc-300 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div className="flex flex-1 items-center justify-center bg-[#0a0a0f] overflow-hidden">
        {renderContent()}
      </div>
    </div>
  );
